        ...
        while True:
            ...
            if choice == "Add some notes via file upload":
                ...
                for i in range(len(file_names)):
                    self.studyai.add_data(file_names[i])
            elif choice == "Ask a question":
                question = questionary.text("What are you wondering?\n> ").ask()
                self.studyai.search_data(question)
                ...
                print("Correct!" if results['answer'] == answer else f"Incorrect, the answer is {results['answer']}")
            elif choice == "Exit":
                break